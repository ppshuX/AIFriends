...
<template>
  <div class="login-page flex justify-center py-8">
    <form @submit.prevent="handleLogin" class="fieldset bg-base-200 border-base-300 rounded-box w-xs border p-4">
      ...
      <input v-model = "username" type="text" class="input input-bordered w-full" placeholder="输入用户名" />

      <label class="label">密码</label>
      <input v-model = "password" type="password" class="input input-bordered w-full" placeholder="输入密码" />
